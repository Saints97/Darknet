...
This means one can have an always-on katanad instance running, and another local katanad/katana-qt instance which connects to this node and receives blocks from it.
