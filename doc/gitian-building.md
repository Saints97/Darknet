...
- [Building DarkNet](#building-katana)
...
Clone the git repositories for katana and gitian and then checkout the katana version that you want to build.
...
Follow the instructions in [doc/release-process.md](release-process.md) in the katana repository
...
gitian builds' in [doc/release-process.md](release-process.md) in the katana repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/katana/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/saints97/katana
...
For example:
```bash
URL=https://github.com/crowning-/katana.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit katana=${COMMIT} --url katana=${URL} ../katana/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit katana=${COMMIT} --url katana=${URL} ../katana/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit katana=${COMMIT} --url katana=${URL} ../katana/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/katana-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/katana-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/katana-build.assert
```
...
[katana/gitian.sigs](https://github.com/saints97/gitian.sigs/) repository, or if that's not possible to create a pull
request.
