...
Only requiring some minor changes is katana.cpp.
...
Changes to katana.cpp
----------------------
katana.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
